...
namespace DapperDemo
{
    public class QueryDemo
    {
        ...
        //static void Main(string[] args)
        {
            ...
            {
                Console.WriteLine("其中，第1条记录的DapperDemoName为：{0}，Type为：{1}，ParentName为：{2}。", dapperDemoList[0].DapperDemoName, dapperDemoList[0].ParentDapperDemo.DapperDemoParentName, dapperDemoList[0].Type);
            }            
            Console.ReadLine();
            ...
            if (dapperDemo != null)
            {
                Console.WriteLine("执行成功：ID为{0}，DapperDemoName为{1}，Type为{2}。", dapperDemo.ID, dapperDemo.DapperDemoName, dapperDemo.Type);
            }
            else
            {
            ...
            {              
                Console.WriteLine("执行成功：ID为{0}，DapperDemoName为{1}，Type为{2}。", dapperDemoDynamic.ID, dapperDemoDynamic.DapperDemoName, dapperDemoDynamic.Type);
            }
            else
            {
                Console.WriteLine("执行成功：没有ID为2000的DapperDemo。");

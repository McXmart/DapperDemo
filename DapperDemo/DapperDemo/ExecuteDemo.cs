...
namespace DapperDemo
{
    public class ExecuteDemo
    {
        ...
        {            
            ...
            {
                Console.WriteLine("新增成功：新增记录的ID为{0}，ParentID为{1}，DapperDemoName为{2}，Type为{3}。", newDapperDemoId, dapperDemo.ParentID, dapperDemo.DapperDemoName, dapperDemo.Type);
            }
            else
            {
            ...
            if (dapperDemoList != null && dapperDemoList.Count > 0)
            {
                ...
                Console.WriteLine("将更新记录ID为{0}的DapperDemoName【{1}】。", dapperDemo.ID, dapperDemo.DapperDemoName);
                Console.ReadLine();
                ...
                if (rowAffected == 1)
                {
                    ...
                    if (dapperDemo != null)
                    {
                        Console.WriteLine("更新成功：ID为{0}这个的DapperDemoName已被更新为【{1}】。", dapperDemo.ID, dapperDemo.DapperDemoName);
                    }
                }
                else
                {
            ...
            {
                dapperDemo = dapperDemoList[0];
                Console.WriteLine("将删除ID为{0}的记录（其DapperDemoName为{1}）。", dapperDemo.ID, dapperDemo.DapperDemoName);
                Console.ReadLine();
